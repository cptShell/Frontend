			...
			<div className={"relative"}>
				<input
					...
					type="email" className={errors?.email ? "authorization-block__password form__input relative" +
						" border-red-500 mb-8" : "authorization-block__password form__input relative mb-8"} placeholder="Email"
			...
			<div className={"relative"}>
				<input
					...
					type={checkPassword ? 'text' : 'password'} className={errors?.password ? "authorization-block__password form__input relative mb-8" +
						" border-red-500" : "authorization-block__password form__input relative mb-8"}
